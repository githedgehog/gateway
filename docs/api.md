...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `statefulNat` _[PeeringStatefulNAT](#peeringstatefulnat)_ | Use connection state tracking when performing NAT |  |  |
| `statelessNat` _[PeeringStatelessNAT](#peeringstatelessnat)_ | Use connection state tracking when performing NAT, use stateful NAT if omitted |  |  |
