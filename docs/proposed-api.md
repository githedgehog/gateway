...
firewall:
  - deny: 
      ...
      log: # log traffic event for given pattern
        logLevel: debug # warning | info | error
    ...
    vpc-1:
      ...
      firewall:
        ...
        - allow:
            ...
            log:
              logLevel: debug
              logMessage: "Kubernetes API response to vpc-1"
            tcp:
              src:
                ports: [6443]
              dst:
        ...
        - deny:
            ...
            log:
              logLevel: error
              logMessage: "vpc-k8s tries to access vpc-1"
    vpc-kubernetes:
      expose:
        - ips:
      ...
      firewall:
        - allow:
            ...
            log:
              logLevel: info
              logMessage: "vpc-1 Kubernetes API access"
            tcp:
              src:
                cidrs:
